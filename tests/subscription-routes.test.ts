...
process.env['DYNAMODB_PACKAGES_TABLE'] = 'Packages-test';
process.env['DYNAMODB_SUBSCRIPTION_TYPES_TABLE'] = 'SubscriptionTypes-test';
process.env['DYNAMODB_SUBSCRIPTIONS_TABLE'] = 'Subscriptions-test';
